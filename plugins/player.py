...
async def play(_, message: Message):
        ...
        for administrator in administrators:
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"**🎸 Ƥɭɘɑsɘ ❤️ Ɱɑŋʋɑɭɭy 🥀 Ʌɗɗ 💫 Ʌssɩsʈɑŋʈ 😔 Øɤ 🎸 Ƈøŋʈɑƈʈ ❤️ ʈø : @MR_BHAGWAN 🥀** ")
    try:
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://te.legra.ph/file/8a7ad41404f3bf904640e.jpg"
...
async def pause(_, message: Message):
    ...
    await message.reply_photo(
                             photo="https://te.legra.ph/file/8a7ad41404f3bf904640e.jpg", 
                             caption="**💥 AƈƚιʋҽX 🔈 Mʋsɩƈ🤞Nøω 🥀\n▶️ Ƥɑʋsɘɗ 🌷 ...**"
    )
...
async def skip(_, message: Message):
    ...
    if int(chat_id) not in ACTV_CALLS:
        await message.reply_text("**💥 AƈƚιʋҽX 💞 Ɲøʈɦɩɳʛ 🔇\n🚫 Ƥɭɑyɩɳʛ 🌷 ...**")
    else:
